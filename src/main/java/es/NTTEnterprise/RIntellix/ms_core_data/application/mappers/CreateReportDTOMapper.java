...
public class CreateReportDTOMapper {
     ...
     */
    public Report toDomain(CreateReportDTO dto) {
        if (dto == null) {
            return null;
        }
    ...
    private ReportType parseReportType(String reportType) {
        try {
            ...
            throw new IllegalArgumentException(
                    String.format(LogMessage.EXCEPTION_INVALID_REPORT_TYPE, reportType));
        }
    }
    ...
    private Severity parseSeverity(String severity) {
        try {
            ...
            throw new IllegalArgumentException(
                    String.format(LogMessage.EXCEPTION_INVALID_SEVERITY, severity));
        }
    }
}

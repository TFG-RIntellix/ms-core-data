 ...
 * This class will be responsible for mapping the Request entity from the domain layer to the RequestDetails
 * DTO in the application layer, allowing to transfer detailed information about a request without exposing the internal structure of the Request entity.
...
public class RequestDetailsDTOMapper {
 ...
 public RequestDetailsDTO toDTO(Request request) {
        ...
        requestDetailsDTO.setRequestedAmount(request.getRequestDetails().getRequestedAmount() != null ? request.getRequestDetails().getRequestedAmount().getAmount() : null);
        requestDetailsDTO.setCurrency(request.getRequestDetails().getRequestedAmount() != null ? request.getRequestDetails().getRequestedAmount().getCurrency() : null);

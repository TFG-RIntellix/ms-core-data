 ...
 * Contains financial affordability metrics: monthly payment, DTI, total
 * payment,
...
public class FinancialMetricsEntity {
    ...
    /**
     * Default constructor for FinancialMetricsEntity.
     */
    public FinancialMetricsEntity() {
    }

    /**
     * Parameterized constructor for FinancialMetricsEntity.
     *
     * @param monthlyPayment          the monthly payment amount
     * @param debtToIncomeRatio       the DTI ratio
     * @param totalPayment            the total payment over the term
     * @param totalInterest           the total interest cost
     * @param monthlyDisposableIncome the monthly disposable income
     */
    public FinancialMetricsEntity(
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        FinancialMetricsEntity other = (FinancialMetricsEntity) obj;

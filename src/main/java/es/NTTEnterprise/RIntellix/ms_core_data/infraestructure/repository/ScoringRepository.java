...
public interface ScoringRepository extends MongoRepository<ScoringEntity, String> {
    ...
    /**
     * Finds the most recent scoring for a given request ID, ordered by scoring_date descending.
     * @param requestId The ID of the request (as stored in request_id field).
     * @return An Optional containing the latest ScoringEntity, or empty if none found.
     */

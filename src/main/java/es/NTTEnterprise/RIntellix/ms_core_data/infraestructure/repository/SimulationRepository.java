...
/**
 * Repository interface for SimulationEntity in the "simulations" MongoDB collection.
...
public interface SimulationRepository extends MongoRepository<SimulationEntity, String> {
     ...
     * @param requestId the ID of the associated request (optional filter, as ObjectId)
     * @param partyId the ID of the associated party (optional filter, as ObjectId)
